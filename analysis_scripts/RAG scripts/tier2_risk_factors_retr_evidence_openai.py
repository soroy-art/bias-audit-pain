"""
Full Factorial Experiment - Tier 2 (Risk Factors + Binary Dosage)
================================================================
WITH risk factors, binary dosage (Low/High)
...
#OUTPUT_FILE = "../experiment_results/results_post_op_gpt4o_mini_tier2_ff.csv"
#OUTPUT_FILE = "../experiment_results/results_post_op_gpt41_mini_tier2_ff.csv"
#OUTPUT_FILE = "../experiment_results/results_post_op_gpt5_mini_tier2_ff.csv"
#OUTPUT_FILE = "experiment_results/results_retr_evidence_post_op_gpt4o_mini_tier2_ff_Apr10.csv"
OUTPUT_FILE = "experiment_results/results_retr_evidence_post_op_gpt5_4_tier2_ff_May12.csv"
...
# Helper functions (same as Tier 1)
...
def save_backup(results_list, call_count):
    ...
    backup_path = f"{BACKUP_DIR}tier2_backup_{call_count}.csv"
...
if __name__ == "__main__":
    print("=" * 80)
    print("TIER 2: Full Factorial Experiment (Risk Factors + Binary Dosage)")
    print("=" * 80)
